...
var cs_js = require('flatpickr/dist/l10n/cs.js');
...
Datetime.config = {
  ...
  create: (options = {}) => {
    ...
    minDash.set(defaults, DATE_LABEL_PATH, 'Datum');
    return {
      ...defaults,
      ...options
    };
    ...
    return jsxRuntime.jsxs("div", {
      ...
      children: [showAdd ? jsxRuntime.jsx("button", {
        ...
        children: jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [jsxRuntime.jsx(AddSvg, {}), " ", 'Přidat']
        })
        ...
        children: isCollapsed ? jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [jsxRuntime.jsx(ExpandSvg, {}), " ", `Rozbalit vše (${values.length})`]
        }) : jsxRuntime.jsxs(jsxRuntime.Fragment, {
          children: [jsxRuntime.jsx(CollapseSvg, {}), " ", 'Sbalit']
        })
      }) : null]
    });
  }
