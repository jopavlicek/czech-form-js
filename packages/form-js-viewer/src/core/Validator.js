...
function runNumberValidation(field, value) {
  ...
  if (value === 'NaN') {
    errors.push('Hodnota musí být platné číslo.');
  } else if (value) {
    ...
    if (increment) {
      ...
      if (offset.cmp(0) !== 0) {
        ...
        errors.push(`Prosím, zvolte platnou hodnotu. Dvě nejbližší hodnoty jsou ${previousValue} a ${nextValue}.`);
      }
    }
  }
